...
| `/e/{slug}/calendar.ics` | the same event as a calendar file (RFC 5545), for Google Calendar and the rest; the page links it as "Add to calendar", beside a Share button that copies the URL |
